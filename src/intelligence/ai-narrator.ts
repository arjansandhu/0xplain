...
${JSON.stringify(decoded, null, 2)}`,
    ...
    console.warn("[ai-narrator] Explanation generation failed, returning without narrative:", (err as Error).message);
    return "(AI narrative unavailable — Claude API error)";
  }
}
...
${JSON.stringify(flags, null, 2)}`,
    ...
    console.warn("[ai-narrator] Risk narrative generation failed, returning without narrative:", (err as Error).message);
    return "(AI narrative unavailable — Claude API error)";
  }
}
